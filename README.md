# BrandMarket
BrandMarket — маркетплейс брендовой одежды
## Стек:
...
- Полноценное SPA
- Фронтенд: TypeScript, React, Redux Toolkit, Axios, MaterialUI, Styled-components
- Бекенд: Node.js, Express, PostgreSQL, Sequelize ORM, Bcrypt, Multer, NodeMailer
