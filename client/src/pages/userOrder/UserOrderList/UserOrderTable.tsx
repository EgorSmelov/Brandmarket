...
export default function UserOrderTable({ orders }: BasketTablePropsType): JSX.Element {
  return (
    <Container>
          ...
          <TableBody>
            {orders.map((good, index) => (
              <TableRow key={good.title} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                ...
                <TableCell align="center">{good.userPurchases[0].Purchases.quantity}</TableCell>
                <TableCell align="center">
                  {good.userPurchases[0].Purchases.orderPrice}
                  <RubleIcon />
                </TableCell>
              </TableRow>
            ))}
