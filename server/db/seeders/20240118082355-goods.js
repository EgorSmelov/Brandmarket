    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          ...
          description:
            "Материал: Верх - 100% полиэстер; Подкладка - 100% полиэстер; Наполнитель - 85% пух, 15% перо.Страна-производитель: Китай.Свободный крой.Прямой силуэт.Контрастный объемный принт.Утеплитель из натурального пуха.Воротник-стойка.Застёжка на молнии.Два боковых кармана.Эластичные подол и манжеты.Вышитый брендинг",
          color: "Коричневый",
          categoryId: 4,
          genderId: 1,
          brandId: 1,
        ...
        },
        {
          ...
          description:
            "Материал: 100% хлопок.Страна-производитель: Бангладеш.Плотная вельветовая ткань.Свободный крой.Прямой силуэт.Фиксированный отложной воротник.Застёжка на пуговицах.Манжеты на пуговицах.Вышитый брендинг",
          color: "Черный",
          categoryId: 6,
          genderId: 1,
          brandId: 6,
